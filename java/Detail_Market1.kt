...
import kotlinx.android.synthetic.main.activity_detail__market1.*

class Detail_Market1 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_detail__market1)
        ...
        val adapter = Adapter(featureList, LayoutInflater.from(this@Detail_Market1))
        market_recycler_view.adapter = adapter
        market_recycler_view.layoutManager = LinearLayoutManager(this@Detail_Market1)
    }
}
...
class Adapter(
    ...
    class ViewHolder(featureView: View) : RecyclerView.ViewHolder(featureView) {
        ...
        init {
            featureText = featureView.findViewById(R.id.market_feature)
        }
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = inflater.inflate(R.layout.detail_market1_feature_item_view, parent, false)
