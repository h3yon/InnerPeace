...
import kotlinx.android.synthetic.main.activity_detail__beer1.*

class Detail_Beer1 : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_detail__beer1)
        ...
        beer_recycler_view.adapter = adapter
        beer_recycler_view.layoutManager = LinearLayoutManager(this@Detail_Beer1)
    }
}
...
class Adapter(
    ...
    class ViewHolder(featureView: View) : RecyclerView.ViewHolder(featureView) {
        ...
        init {
            featureText = featureView.findViewById(R.id.beer_feature)
        }
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = inflater.inflate(R.layout.detail_beer1_feature_item_view, parent, false)
