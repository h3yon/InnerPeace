...
class Detail_Sub7_view : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sub7List.add(("상동(외부)"))
        sub7List.add(("부천시청(외부)"))
        sub7List.add(("신중동(외부)"))
        sub7List.add(("춘의(외부)"))
        sub7List.add(("부천종합운동장(내외부)"))
        sub7List.add(("까치울(외부)"))
        sub7List.add(("온수(외부)_1, 7"))
        sub7List.add(("천왕(외부)"))
        sub7List.add(("광명 사거리(외부)"))
        sub7List.add(("철산(외부)"))
        sub7List.add(("가산디지털단지(외부)_1, 7"))
        sub7List.add(("남구로(외부)"))
        sub7List.add(("대림(외부)_2, 7"))
        sub7List.add(("신풍(외부)"))
        sub7List.add(("보라매(외부)"))
        sub7List.add(("신대방삼거리(외부)"))
        sub7List.add(("장승배기(외부)"))
        sub7List.add(("상도(외부)"))
        sub7List.add(("숭실대 입구(외부)"))
        sub7List.add(("남성(외부)"))
        sub7List.add(("총신대입구(이수)(내외부)_4, 7"))
        sub7List.add(("내방(외부)"))
        sub7List.add(("고속터미널(외부)_3, 7, 9"))
        sub7List.add(("반포(외부)"))
        sub7List.add(("논현(외부)"))
        sub7List.add(("학동(외부)"))
        sub7List.add(("강남구청(외부)"))
        sub7List.add(("청담(외부)"))
        sub7List.add(("뚝섬유원지(내부)"))
        sub7List.add(("건대입구(내부)_2, 7"))
        sub7List.add(("어린이대공원(외부)"))
