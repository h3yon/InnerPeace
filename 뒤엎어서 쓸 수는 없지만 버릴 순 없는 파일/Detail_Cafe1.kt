...
import kotlinx.android.synthetic.main.activity_detail__cafe1.*

class Detail_Cafe1 : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_detail__cafe1)
        ...
        val adapter = Adapter(featureList, LayoutInflater.from(this@Detail_Cafe1))
        cafe_recycler_view.adapter = adapter
        cafe_recycler_view.layoutManager = LinearLayoutManager(this@Detail_Cafe1)
    }
}
...
//
//        init {
//            featureText = featureView.findViewById(R.id.cafe_feature)
//        }
//    }
//
//    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
//        val view = inflater.inflate(R.layout.detail_cafe1_feature_item_view, parent, false)
